...
export default function Home() {
  ...
  const schema =
  {
    ...
    "headline": `${MANGA_NAME}: Beyond Journey's End Manga`,
  ...
  const head = () => (
    <Head>
      <title>{`Read ${MANGA_NAME}: Beyond Journey's End Manga Online`}</title>
      <meta name="description" content={APP_DESCRIPTION} />
      <link rel="canonical" href={`${DOMAIN}`} />
      <meta property="og:title" content={`Read ${MANGA_NAME}: Beyond Journey's End Manga Online`} />
      ...
      <article>
        ...
        <div className="md:flex md:mb-[60px] mb-5 pt-3 relative bg-[black]">
          ...
          <div className="md:w-3/5 md:mr-10  text-white p-5 relative z-10">
            <h1 className="text-center font-extrabold text-4xl my-5 uppercase">{`${MANGA_NAME}: Beyond Journey’s End`}</h1>
