...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const schema =
    {
        ...
        "headline": `${MANGA_NAME}: Beyond Journey's End Chapter ${chapterNumber}`,
    ...
    return (
        <>
            ...
            <article>
                ...
                <p className='text-center px-4'>{`You are reading ${MANGA_NAME}: Beyond Journey's End`} <b>{`Chapter ${chapterNumber}`}</b></p>
